			...
			<q-form @submit="submit" @reset="reset">
				<q-card class="q-pa-lg q-mb-lg" bordered>
					<div class="q-col-gutter-md row">
						...
						<div v-for="(_, index) in instantiateForm.funds" :key="index" class="col-12">
						<q-card class="q-pa-sm q-col-gutter-xs row" bordered>
							...
							<q-input
								...
								:rules="[
									...
									(val) =>
									compareBalance(val, bankStore.balanceDisplay(instantiateForm.funds[index].denom)?.amount ?? '0') ||
